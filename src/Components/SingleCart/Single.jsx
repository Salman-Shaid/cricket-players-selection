...
const Single = ({cart,handleSelectedProduct}) => {
    ...
    return (
        <div className='space-x-4 border p-2 rounded-lg shadow-md'>
            <img className='bg-cover h-64 w-full rounded-lg' src={cover} alt="" />
            ...
            <div className='flex justify-between items-center'>
                <p>price: ${price}</p>
                <button onClick={()=>handleSelectedProduct(cart)} className='btn bg-gray-100 p-2 rounded-lg'>Choose player</button>
